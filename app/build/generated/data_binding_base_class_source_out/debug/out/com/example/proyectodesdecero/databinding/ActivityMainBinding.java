...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText inputUsuarios;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button botonLogin,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.inputUsuarios;
      EditText inputUsuarios = ViewBindings.findChildViewById(rootView, id);
      if (inputUsuarios == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, botonLogin, editTextTextPassword,
